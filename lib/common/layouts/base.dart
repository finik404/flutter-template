...
class BaseLayout extends StatelessWidget {
  ...
  final bool hasAppBar, isResizeKeyboard;
  ...
  Widget build(BuildContext context) {
    ...
    EdgeInsets customPadding = padding ?? EdgeInsets.zero;
    ...
    return hasSafeArea
        ? Scaffold(
            resizeToAvoidBottomInset: isResizeKeyboard,
