...
class UIInputState extends State<UIInput> {
  ...
  void initState() {
    ...
    // isNotEmpty
    if (widget.isPassword || widget.hideIcon) {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle inputPrefixIconStyles = widget.prefixIconStyles ?? TextStyle(fontSize: 16, color: TColors.primary.withOpacity(0.5));
      ...
      children: [
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            disabledBorder: inputStyles.disabledBorder,
            ...
            suffixIcon:
                ...
                widget.isPassword && isNotEmpty
                    ...
                    // SuffixIcon
                    : widget.suffixIcon != null && (widget.hideIcon && isNotEmpty)
            ...
            error.isNotEmpty
                ? Expanded(
                    child: Container(
                      ...
                      child: UIText(error, styles: const TextStyle(fontSize: 12, color: TColors.error)),
                    ),
                  )
                : Container(),
